...
if __name__ == "__main__":
    ...
    cfg = Config("uhc_1", "train", create_dirs=False)
    env = HumanoidEnv(cfg)
    amass_cc = joblib.load("/insert_directory_here/amass_uhc_take1.pkl")
    ...
    joblib.dump(neutral_dump, "/insert_directory_here/standing_neutral.pkl")
