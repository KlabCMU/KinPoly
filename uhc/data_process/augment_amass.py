...
def fix_height(expert, expert_meta, env):
    ...
    if ground_pene < -0.15:
        print(f"{expert_meta['seq_name']} negative sequence invalid for uhc: {ground_pene}")
        return None
    return new_expert
...
if __name__ == "__main__":
    ...
    amass_seq_data = {}
    seq_length = -1
    cfg = Config("uhc_5", None, create_dirs=False)
    ...
    amass_occlusion = joblib.load("/insert_directory_here/amass_uhc_occlusion.pkl")
