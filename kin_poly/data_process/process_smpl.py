...
from kin_poly.utils import get_qvel_fd, de_heading
from kin_poly.utils.torch_humanoid import Humanoid
from kin_poly.utils.transformation import quaternion_multiply, quaternion_inverse,  rotation_from_quaternion
...
if __name__ == "__main__":
    ...
    # data_load = joblib.load("/insert_directory_here/amass_uhc_take3.pkl")
    data_load = joblib.load("/insert_directory_here/kin_poly_uhc.pkl")
