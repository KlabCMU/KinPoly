...
from kinpoly.utils import get_qvel_fd, de_heading
from kinpoly.utils.torch_humanoid import Humanoid
from kinpoly.utils.transformation import quaternion_multiply, quaternion_inverse,  rotation_from_quaternion
...
if __name__ == "__main__":
    ...
    data_load = joblib.load("/insert_directory_here/kinpoly_uhc.pkl")
