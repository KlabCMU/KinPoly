...
from kinpoly.utils.transform_utils import *
from kinpoly.utils.transformation import quaternion_from_euler_batch, \
...
if __name__ == "__main__":
    import argparse
    from kinpoly.data_loaders.statereg_dataset import Dataset
    from kinpoly.envs.humanoid_v2 import HumanoidEnv
    from kinpoly.utils.egomimic_config import Config as EgoConfig
    ...
    data_load = joblib.load("/insert_directory_here/kinpoly_mocap_qpos_grad.pkl")
